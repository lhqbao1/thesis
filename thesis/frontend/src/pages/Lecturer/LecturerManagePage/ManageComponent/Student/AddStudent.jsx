...
const AddStudent = (props) => {
    ...
    const onFinish = async (values) => {
        try {
            ...
            const resUser = await callCreateUser(values.student_email, '123456', 2)
            if (resUser) {
                const res = await callCreateStudent(resUser?.data?.payload?.user_id, values.student_name, values.student_class, values.student_code, values.student_email, values.student_grade, values.student_major, null, null)
                if (res) {
