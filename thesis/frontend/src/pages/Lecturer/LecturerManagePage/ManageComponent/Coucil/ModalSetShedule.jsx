...
import { callCreateSchedule, callGetScheduleByRoom, callUpdateTopicSchedule } from "../../../../../../services/api";
const { RangePicker } = DatePicker;

const ModalSetSchedule = (props) => {
    ...
    const onFinish = async (values) => {
        ...
        if (res) {
            ...
            if (free === true) {
                const resSchedule = await callCreateSchedule(values.room, start, end, 'đề cương', dataTopic?.topic_id)
                if (resSchedule) {
    ...
    return (
        <div>
            <Modal title="Phân công thời gian báo cáo"
