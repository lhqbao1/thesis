...
import { callCreateCoucil } from "../../../../../../services/api";

const CreateCoucilReport = (props) => {
    ...
    const onFinish = async (values) => {
        const res = await callCreateCoucil(values.name, values.type, 2)
        if (res) {
            form.resetFields()
...
export default CreateCoucilReport